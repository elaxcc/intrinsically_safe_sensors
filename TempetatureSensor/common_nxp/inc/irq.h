...
/* modified by Martin Thomas for GNU compatiblity */
...
#ifdef __GNUC__
/*
	mthomas: I'm using a irq-assembler wrapper
	(see startup_gnu.S) so no 
	#define __irq __attribute__ ((interrupt("IRQ"))) 
	here. The attribute does not work reliably under
	certain conditions anyway. Instead just this: */
#define __irq
#define IENABLE
#define IDISABLE
#else
...
#define IENABLE     /* disabled - mthomas */
#define IDISABLE
#endif
